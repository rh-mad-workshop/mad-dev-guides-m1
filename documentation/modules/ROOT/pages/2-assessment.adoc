...
<a href="https://tackle-tackle-%USERID%.apps.%SUBDOMAIN%" target="_blank" rel="noopener">Tackle web consoledddd</a>

Open a new browser to access the https://tackle-tackle-%USERID%.apps.%SUBDOMAIN%[Tackle web console^].

https://codeserver-codeserver-%USERID%.apps.%SUBDOMAIN%[VS Code server instance^]

Open a new browser to access the https://tackle-tackle-user1.apps.cluster-rhgm7.sandbox1842.opentlc.com[Tackle web console2^].
