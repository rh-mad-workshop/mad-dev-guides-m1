...
When you have finished the all of the modules in Dev track, your TO-BE deployment architecture should look like this:
...
* `Migration Toolkit for Applications` to help modernize the customer service Java source code.
