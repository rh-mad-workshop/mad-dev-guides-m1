...
* Assessment and Analysis of legacy application using https://www.konveyor.io/tools/tackle/[Konveyor Tackle^]

[NOTE]
====
_Tackle_ is part of the *Migration Toolkit for Applications (MTA)*, which provides application assessment and analysis features.
====
